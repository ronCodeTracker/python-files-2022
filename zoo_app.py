...
# ר ו נ  א ל ד
# June 10, 2022   Friday
# zoo opp project for bootcamp K state
...
person_one = Person("Cora", 80)


print(person_one.name)


zoo_okc = Zoo("Oklahoma City Zoo")

print(zoo_okc.name)

animal_zebra = Animal("zebra")

print(animal_zebra.name)

zoo_okc.add_animal("zebra")

print(zoo_okc.animals)
